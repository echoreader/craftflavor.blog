      ...
      <div className="max-w-6xl mx-auto px-6 py-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden sm:flex gap-6 text-sm font-medium text-gray-700 tracking-wide">
            ...
            <Link href="https://craftflavor.blog/blog" className="px-3 py-2 rounded-md hover:bg-gray-100 hover:text-blue-600 transition">Blog</Link>
            <Link href="https://craftflavor.blog/about" className="px-3 py-2 rounded-md hover:bg-gray-100 hover:text-blue-600 transition">About</Link>
          </nav>
        </div>
